...
export default function Hero() {
    const { name, title, tagline } = portfolioDataJSON.personalInfo;
    ...
    return (
        <section id="home" className="relative min-h-screen pt-28 overflow-hidden">
            ...
            <div className="section-container relative z-10 grid lg:grid-cols-[1.15fr_0.85fr] gap-10 items-center">
                <div className="text-center lg:text-left">
                    <motion.div
                        initial={{ opacity: 0, y: 16 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.45 }}
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#64f5d24d] bg-[#0fbc9a12] text-[#9fffe8] text-sm font-medium mb-7"
                    >
                    ...
                    >
                        {name}
                        <span className="block text-[#f7d47c] mt-2">AI x Backend Engineer</span>
                    </motion.h1>
                    ...
                    <motion.h2
                        ...
                        className="mt-5 text-xl md:text-2xl text-slate-200 font-semibold"
                    >
                        {title}
                    </motion.h2>
                ...
                <motion.aside
                    ...
                    className="minimal-card p-7 h-fit relative overflow-hidden"
                >
